...
CREATE TABLE acceptance_criteria (
    ...
    generated_by_ai BOOLEAN NOT NULL DEFAULT false,
    approved_at TIMESTAMPTZ,
    UNIQUE (requirement_version_id, sequence)
);
...
COMMENT ON COLUMN document_chunks.embedding IS 'Vector embedding generated by the configured embedding provider. Dimension is constrained by the embedding model during deployment.';
